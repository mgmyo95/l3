...
getaudioscreen.addEventListener('ended',nextado);
...
function setaudioprogress(e){
    ...
    // console.log(width);
    let getclickx = e.offsetX;
    // console.log(getclickx);
    let duration = getaudioscreen.duration;

    getaudioscreen.currentTime = (getclickx/width)*duration;
